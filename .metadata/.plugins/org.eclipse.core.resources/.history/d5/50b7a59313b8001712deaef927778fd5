...
SDK/platform/drivers/src/clock/S32K1xx/clock_S32K1xx.o: ../SDK/platform/drivers/src/clock/S32K1xx/clock_S32K1xx.c
	...
	arm-none-eabi-gcc "@SDK/platform/drivers/src/clock/S32K1xx/clock_S32K1xx.args" -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@)" -c -o "SDK/platform/drivers/src/clock/S32K1xx/clock_S32K1xx.o" "$<"
